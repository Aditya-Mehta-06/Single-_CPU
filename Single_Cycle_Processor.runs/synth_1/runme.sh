...
HD_PWD='C:/Users/adity/Single_cycle_cpu/Single_Cycle_Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Single_Cycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_Single_Cycle.tcl
