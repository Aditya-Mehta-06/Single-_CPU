...
HD_PWD='C:/Users/adity/Single_cycle_cpu/Single_Cycle_Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Single_Cycle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_Single_Cycle.tcl -notrace
